...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between items-center">
            <a href="/">
                <h1 class="text-3xl font-black" style="font-family: Satisfy">DevStagram</h1>
            </a>
            {{-- Revisamos si el usuario esta autenticado --}}
            @auth
                <nav class="flex gap-2 items-center">
                    <a class="flex items-center gap-2 bg-white border p-2 text-gray-600 rounded text-sm cursor-pointer uppercase font-bold"
